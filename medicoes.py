...
if pagina == "🔎 Visualização":
    ...
    tabelas_tratatas['valor_unitario_standby'] = tabelas_tratatas['valor_unitario_standby'].str.replace('R$', '').str.strip()
    tabelas_tratatas['valor_unitario_standby'] = tabelas_tratatas['valor_unitario_standby'].astype(float)
